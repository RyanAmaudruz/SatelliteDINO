...
class FakeArgs:
    ...
    num_workers = 18
    patch_size = 16
    # pretrained = '/gpfs/work5/0/prjs0790/data/run_outputs/checkpoints/odin/run_2024-03-25_18-26/ckp-epoch=03.ckpt'
...
# img_list = [train_dataset.__getitem__(i) for i in (52, 124, 125)]

img_list = [train_dataset.__getitem__(i) for i in range(200, 220)]
...
for i in range(20):
    ...
    img1rgb = np.flip(img1[0, 1:4, :, :], 0)

    img1rgb2 = (img1rgb * 2).clip(0, 255).astype(int)
...
arr_t = val_transform(np.transpose(img1[0], (1, 2, 0)))
...
#
#     print(f'n cluster: {i}, silhouette score: {sil_score}')
#
