...
def load_patch(patch_id, snapshot, band):
    file_path = f'/gpfs/scratch1/shared/ramaudruz/s2a_uncompressed/0k_251k_uint8_jpeg_tif_s2a_{band}.h5'
...
start = time.time()
count = 0
with h5py.File('/gpfs/work5/0/prjs0790/data/ssl4eo-s12/s2a_un/s2a_264_new.h5', 'w') as f:
