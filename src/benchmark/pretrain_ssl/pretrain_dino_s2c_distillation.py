...
def train_dino(args):
    ...
    teacher_msg = teacher_without_ddp.load_state_dict(student.state_dict(), strict=False)
...
def train_one_epoch(student, teacher, teacher_without_ddp, dino_loss, data_loader,
    ...
    for it, images in enumerate(metric_logger.log_every(data_loader, 10, header)):
        ...
        with torch.cuda.amp.autocast(fp16_scaler is not None):
            ...
            loss = dino_loss_out + distillation_loss * 2
        ...
        metric_logger.update(dino_loss_out=dino_loss_out.item())
...
class DataAugmentationDINO_S2(object):
    def __init__(self, global_crops_scale, local_crops_scale, local_crops_number, season='fixed'):
        ...
        self.global_transfo1 = transforms.Compose([
            ...
            # torchvision.transforms.RandomResizedCrop(args.in_size, scale=global_crops_scale, interpolation='BICUBIC'),
            flip_and_color_jitter,
...
class FakeArgs:
    ...
    bands = 'B13'
    batchsize = 96
    checkpoints_dir = '/gpfs/work5/0/prjs0790/data/run_outputs/checkpoints/ssl4eo_ssl/new_testing'
    clip_grad = 3.0
    data = ''
    dist_url = ''
    drop_path_rate = 0.1
