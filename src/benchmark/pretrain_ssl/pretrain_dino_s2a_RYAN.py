...
from datasets.SSL4EO.ssl4eo_dataset_lmdb_new import LMDBDatasetS2A
...
def train_dino(args):
    ...
    dataset = LMDBDatasetS2A(
        lmdb_file=None,
        s2a_transform=transform,
        normalize=args.normalize,
        dtype=args.dtype,
        mode=args.mode
    )
...
class FakeArgs:
    ...
    bands = 'B12'
    batchsize = 128
    checkpoints_dir = '/gpfs/home2/ramaudruz/SSL4EO-S12/output/checkpoints/ssl_s2a_1_240130'
    clip_grad = 3.0
    data = ''
    dist_url = ''
    drop_path_rate = 0.1
