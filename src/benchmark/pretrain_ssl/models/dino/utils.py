...
#             # state_dict['patch_embed.proj.weight'] = torch.concat([state_dict['patch_embed.proj.weight']] * 4, 1)
#             updated_state_dict = model.state_dict()
#             updated_state_dict['patch_embed.proj.weight'][:, :3, :, :] = state_dict['patch_embed.proj.weight']
#             updated_state_dict['patch_embed.proj.weight'][:, 2:5, :, :] = state_dict['patch_embed.proj.weight']
#             updated_state_dict['patch_embed.proj.weight'][:, 5:8, :, :] = state_dict['patch_embed.proj.weight']
#             updated_state_dict['patch_embed.proj.weight'][:, 9:12, :, :] = state_dict['patch_embed.proj.weight']
#             updated_state_dict['patch_embed.proj.weight'][:, 12:, :, :] = state_dict['patch_embed.proj.weight'][:, :1, :, :]
...
class MultiCropWrapperDistillation(nn.Module):
    """
    Perform forward pass separately on each resolution input.
    The inputs corresponding to a single resolution are clubbed and single
    forward is run on the same resolution inputs. Hence we do several
