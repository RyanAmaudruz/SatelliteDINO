...
from src.benchmark.transfer_change_detection.models.segmentation_new_new import get_segmentation_model
...
class ViTWrapperSiam(LightningModule):
    def __init__(self, vit_backbone):
        super().__init__()
        self.model = get_segmentation_model(vit_backbone, feature_indices, feature_channels)
...
class FakeArgs:
    ...
    # arch = 'vit_small'
    data_dir = '/gpfs/work5/0/prjs0790/data/oscd/Onera Satellite Change Detection dataset - Images'
    ckp_path = '/gpfs/work5/0/prjs0790/data/run_outputs/checkpoints/ssl4eo_ssl/ssl_s2c_new_transforms/checkpoint0095.pth'
    # ckp_path = '/gpfs/work5/0/prjs0790/data/run_outputs/checkpoints/leopart_ssl/leopart_new_transform/leopart-20240301-143933/ckp-epoch=49.ckpt'
    # ckp_path = '/gpfs/work5/0/prjs0790/data/old_checkpoints/B13_rn50_moco_0099_ckpt.pth'
    checkpoint_key = 'teacher'
    gpus = 1
    init_type = 'random'
...
if __name__ == '__main__':
    ...
    model = SiamSegment(post_odin_model1, feature_indices=(2, 4, 5, 6, 7), feature_channels=(384, 384, 384, 384, 384))
    ...
    # model = ChangeDetectionModel(backbone_cp=args.ckp_path, lr=args.lr)
