...
try:
    from datasets.BigEarthNet.bigearthnet_dataset_seco_lmdb_s2_uint8 import \
        LMDBDatasetRA, LMDBDataset, random_subset
except:
    from src.benchmark.transfer_classification.datasets.BigEarthNet.bigearthnet_dataset_seco_lmdb_s2_uint8 import \
        LMDBDatasetRA
    from src.benchmark.pretrain_ssl.datasets.SSL4EO.ssl4eo_dataset_lmdb import LMDBDataset, random_subset
...
try:
    ...
    from src.benchmark.pretrain_ssl.models.dino import utils



# load bigearthnet dataset
# from src.benchmark.datasets.BigEarthNet.bigearthnet_dataset_seco_lmdb_s2_uint8 import LMDBDataset, random_subset, LMDBDatasetRA
...
def eval_linear(args):
    ...
    # checkpoints = [
    #     f'/gpfs/work5/0/prjs0790/data/run_outputs/checkpoints/odin/run_2024-03-17_14-41/ckp-epoch=0{i}.ckpt'
    #     for i in range(5)
    # ]

    # checkpoints = [
    #     f'/gpfs/work5/0/prjs0790/data/run_outputs/checkpoints/odin/run_2024-03-19_07-42/ckp-epoch=0{i}.ckpt'
    #     for i in range(5)
    # ]
    ...
    # checkpoints = [
    #     f'/gpfs/work5/0/prjs0790/data/run_outputs/checkpoints/odin/run_2024-03-20_12-11/ckp-epoch=0{i}.ckpt'
    #     for i in range(5)
    # ]

    # checkpoints = [
    #     f'/gpfs/work5/0/prjs0790/data/run_outputs/checkpoints/odin/run_2024-03-22_12-19/ckp-epoch=0{i}.ckpt'
    #     for i in range(5)
    # ]

    # checkpoints = [
    #     f'/gpfs/work5/0/prjs0790/data/run_outputs/checkpoints/odin/run_2024-03-23_12-27/ckp-epoch=0{i}.ckpt'
    #     for i in range(5)
    # ]

    # checkpoints = [
    #     f'/gpfs/work5/0/prjs0790/data/run_outputs/checkpoints/odin/run_2024-03-25_18-26/ckp-epoch=0{i}.ckpt'
    #     for i in range(5)
    # ]

    # checkpoints = [
    #     f'/gpfs/work5/0/prjs0790/data/run_outputs/checkpoints/odin/run_2024-03-30_13-27/ckp-epoch=00.ckpt'
    #     for i in range(2)
    # ]

    # checkpoints = [
    #     f'/gpfs/work5/0/prjs0790/data/run_outputs/checkpoints/odin/run_2024-03-31_15-25/ckp-epoch=00.ckpt'
    #     for i in range(2)
    # ]
    ...
    # checkpoints = [
    #     '/gpfs/work5/0/prjs0790/data/run_outputs/checkpoints/odin/run_2024-03-16_17-48/ckp-epoch=01.ckpt'
    #     for i in range(3)
    # ]
    ...
    # checkpoints = [
    #     '/gpfs/work5/0/prjs0790/data/old_checkpoints/B13_vits16_dino_0099_ckpt.pth'
    #     for i in range(3)
    # ]

    # checkpoints = [
    #     '/gpfs/home2/ramaudruz/detcon-pytorch/detcon-pytorch/xxea7lru/checkpoints/epoch=1-step=7845.ckpt',
    #     '/gpfs/home2/ramaudruz/detcon-pytorch/detcon-pytorch/xxea7lru/checkpoints/epoch=4-step=19614.ckpt',
    #     '/gpfs/home2/ramaudruz/detcon-pytorch/detcon-pytorch/c5bg3ybl/checkpoints/epoch=0-step=3922.ckpt',
    #     '/gpfs/home2/ramaudruz/detcon-pytorch/detcon-pytorch/c5bg3ybl/checkpoints/epoch=2-step=11768.ckpt',
    #     '/gpfs/home2/ramaudruz/detcon-pytorch/detcon-pytorch/d2z8hvep/checkpoints/epoch=0-step=3922.ckpt',
    #     '/gpfs/home2/ramaudruz/detcon-pytorch/detcon-pytorch/d2z8hvep/checkpoints/epoch=1-step=7845.ckpt',
    # ]
    ...
    for c in checkpoints:
        try:
            ...
            # load weights to evaluate
            utils.load_pretrained_weights(model, c, args.checkpoint_key, args.arch, args.patch_size)
            print(f"Model {args.arch} built.")
            ...
            for epoch in range(start_epoch, args.epochs):
                ...
                if epoch % args.val_freq == 0 or epoch == args.epochs - 1:
                    ...
                    test_stats_dic[c] = train_stats
        except Exception as e:
            print(f'Error {e} occurd, skipping {c}')
    ...
    # # with open(f'/gpfs/work5/0/prjs0790/data/run_outputs/linear_BE_1epoch/checkpoint_odin_diff_runs_2024-03-16_17-48_{timestamp}.pkl', 'wb') as file:
    # with open(f'/gpfs/work5/0/prjs0790/data/run_outputs/linear_BE_1epoch/checkpoint_odin_multi_run_2024-03-16_17-48_{timestamp}.pkl', 'wb') as file:
    #
    #     # A new file will be created
    #     pickle.dump(test_stats_dic, file)
...
class FakeArgs:
    ...
    pretrained = '/gpfs/home2/ramaudruz/detcon-pytorch/detcon/odin_checkpoint_1000.pth'
