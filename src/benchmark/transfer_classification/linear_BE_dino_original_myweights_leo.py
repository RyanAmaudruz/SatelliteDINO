...
def eval_linear(args):
    ...
    dataset_train = LMDBDatasetRALeo(
        set_type='train',
        transform=train_transform,
        is_slurm_job=args.is_slurm_job
    )
    dataset_val = LMDBDatasetRALeo(
        set_type='val',
...
class FakeArgs:
    ...
    checkpoints_dir = '/gpfs/work5/0/prjs0790/data/run_outputs/checkpoints/ssl4eo_linear_probing/be_dino_linear_prob_leo_240214/'
    data_path = ''
    dist_url = 'env://'
    epochs = 100
    evaluate = False
