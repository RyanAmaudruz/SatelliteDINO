...
from src.benchmark.pretrain_ssl.models.dino import vision_transformer
...
# from src.benchmark.pretrain_ssl.datasets.BigEarthNet.bigearthnet_dataset_seco import Bigearthnet
# from src.benchmark.pretrain_ssl.datasets.BigEarthNet.bigearthnet_dataset_seco_lmdb_s2_uint8 import LMDBDataset, random_subset, LMDBDatasetRA
...
class FakeArgs:
    ...
    checkpoints_dir = '/gpfs/work5/0/prjs0790/data/run_outputs/checkpoints/ssl4eo_linear_probing/be_dino_linear_prob_new_trans_95_240222/'
    data_path = ''
    dist_url = 'env://'
    epochs = 100
    evaluate = False
